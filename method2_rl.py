...
def evaluate_and_log(
    ...
    for i, batch in enumerate(tqdm(test_loader, desc="Evaluating", disable=not accelerator.is_main_process)):
        ...
        _, (vif, qbf, ssim) = compute_reward(A, B, F_oneshot)
        ...
        if i == 0 and accelerator.is_main_process and SAVE_IMAGES:
            ...
            save_compare_grids(out_dir, A.detach(), B.detach(), [F_oneshot.detach()], prefix="eval")
...
def main():
    ...
    for epoch in range(1, EPOCHS + 1):
        ...
        if epoch % EVAL_FREQ == 0:
            evaluate_and_log(accelerator, policy, fusion_kernel, test_loader, epoch)
